...
public class Aerolinea implements Serializable, IAerolinea {
	...
	public Ruta confirmarRuta(String destinoRuta) {
		...
		if(destinoRuta.equalsIgnoreCase("CancÃºn")) {
			ruta = new Nacional("CDMX", "CancÃºn", "3 H 12 Min", "8:00am");
			listaRutas.add(ruta);
		}
		...
		if(destinoRuta.equalsIgnoreCase("Los Ã�ngeles")) {
			ruta = new Internacional("CDMX", "Los Ã�ngeles", "3 H 25 Min", "9:45am");
			listaRutas.add(ruta);
		}
		if(destinoRuta.equalsIgnoreCase("BogotÃ¡")) {
			ruta = new Internacional("CDMX", "BogotÃ¡", "3 H 45 Min", "1:30pm");
			listaRutas.add(ruta);
		}
		if(destinoRuta.equalsIgnoreCase("PanamÃ¡")) {
			ruta = new Internacional("CDMX", "PanamÃ¡", "2 H 55 Min", "2:45pm");
			listaRutas.add(ruta);
		}
		return ruta;
	}
	...
	public Tiquete agregarTiquete(String idAvion, String viajeSeleccionado, String clase, String origen, String destino, LocalDate fechaSalida, LocalDate fechaRegreso, int numPersonas, double costoTotalViaje, Cliente cliente,
		...
		if(clase.equalsIgnoreCase("EconÃ³mica")) claseCliente = TipoClase.ECONOMICA;
