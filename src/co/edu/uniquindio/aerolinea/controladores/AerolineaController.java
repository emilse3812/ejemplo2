...
public class AerolineaController implements Initializable {
    ...
    // Lista observable para filtrar una bÃºsqueda
	...
	public void initialize(URL location, ResourceBundle resource) {
		...
		//Obtener selecciÃ³n de la tabla
    	...
    	// AÃ±adiendo Listener al value property.
        sldNumeroPersonas.valueProperty().addListener(
             new ChangeListener<Number>() {
  
            public void changed(ObservableValue <? extends Number > observable, Number oldValue, Number newValue) {
                txtLabel.setText("NÃºmero de personas: " + newValue.intValue());
            }
        });
    	...
    	listaCmbDestino.add("CancÃºn");
    	listaCmbDestino.add("Buenos Aires");
    	listaCmbDestino.add("Los Ã�ngeles");
    	listaCmbDestino.add("BogotÃ¡");
    	listaCmbDestino.add("PanamÃ¡");
		...
		tableViewVuelos.getSelectionModel().selectedItemProperty().addListener((obs, oldSeletion, newSelection) -> {
			if(newSelection != null) {
				...
				if(aeronaveSeleccion != null) {
					txtVuelo.setText(aeronaveSeleccion.getNombreAeronave() + "      Id AviÃ³n: " + aeronaveSeleccion.getIdAvion());
	...
	/**
	 * Mostrar informaciÃ³n de los equipajes
	 */
    ...
    /**
     * Obtener los vuelos de la aerolÃ­nea
     * @return
     */
	...
	/**
	 * Obtener los tripulantes de la aerolÃ­nea
	 * @return
	 */
	...
	/**
	 * Obtener los clientes de la aerolÃ­nea
	 * @return
	 */
    ...
    void pasarDatosTablaAsignacionTripulantes(MouseEvent event) {
    	if(listadoTripulantes.isEmpty()) {
    		aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n AsignaciÃ³n Tripulante", "NotificaciÃ³n AsignaciÃ³n Tripulante", "Ya no hay tripulantes para seleccionar", AlertType.WARNING);		
    ...
    void pasarEquipajeAlCarroEmbarque(MouseEvent event) {
    	...
    	if(listadoEquipajes.isEmpty()) {
    		aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", "Ya no hay equipajes para seleccionar", AlertType.WARNING);		
    		...
    		if(equipajeSeleccionEmbarque != null) {
    			try {
					...
					aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", e.getMessage(),AlertType.WARNING);					    	
				}
    		}
    	}
    }
    ...
    private void validarAvion(String numAvion) throws EquipajeException {
    	if(!(listadoEquipajesEmbarque.isEmpty())) {
			...
			else throw new EquipajeException("Los equipajes deben tener el mismo Id del aviÃ³n");
		}
	}
    ...
    /**
     * Realizar AsignaciÃ³n del vuelo
    	...
    	try {
			...
			if(verificarCantidadTripulantes(idVueloSeleccionado, listadoTripulantesAsignados)) {
				...
				try {
					...
					txtTextoConfirmacionRegistroTripulantes.setText("Â¡Los tripulantes han sido registrados con Ã©xito!");
					aplicacionAerolinea.mostrarMensaje("AsignaciÃ³n de Vuelo", "AsignaciÃ³n de Vuelo", "Se realizÃ³ la asignaciÃ³n del vuelo con Ã©xito", AlertType.INFORMATION);
					
					//------- Limpiar campos para una nueva asignaciÃ³n ------------>>
					txtIdAvion.setText("");
					...
					aplicacionAerolinea.mostrarMensaje("AsignaciÃ³n de Vuelo", "AsignaciÃ³n de Vuelo", e.getMessage(), AlertType.WARNING);
				}
	...
	private boolean verificarDatos(String viajeSeleccionado, String clase, String origen, String destino, LocalDate fechaSalida, 
		...
		if(numeroPersonas == 0) notificacion += "El nÃºmero de personas\n";
    ...
    void realizarCompra(ActionEvent event) throws DatosInvalidosException {
    	...
    	if(aeronaveSeleccion == null)  
    		aplicacionAerolinea.mostrarMensaje("GestiÃ³n Tiquetes", "GestiÃ³n Tiquetes", "Seleccione un vuelo de la tabla", AlertType.WARNING);
    	else {
    ...
    void seleccionarPuesto(ActionEvent event) {
    	...
    	if(aeronaveSeleccion == null){
    		aplicacionAerolinea.mostrarMensaje("Compra de Tiquetes", "Compra de Tiquetes", "Para la selecciÃ³n de su puesto primero elija el vuelo en el que va a viajar", AlertType.WARNING);
    	} else {
    		if(aeronaveSeleccion.getNombreAeronave().equals("Airbus A320")) 
    ...
    /**
     * Cargar la vista de la aeronave dependiendo de la elecciÃ³n del usuario
     * @param string
     */
    private void cargarVista(String nombreView) {
    	try {
			...
			dialogStage.setTitle("OcupaciÃ³n Sillas");
	...
	private void agregarCompraTiquetes(String identificacionOPasaporte, String nombre, String apellido, String direccion, String correoElectronico, LocalDate fechaNacimiento,
		...
		try {
			...
			// AÃ±adir el cliente al filtro al momento de agregarlo al tableview
			...
			aplicacionAerolinea.mostrarMensaje("Compra de Tiquetes", "Compra de Tiquetes", "La compra de su tiquete con destino a " + tiquete.getRutaViaje().getCiudadDestino() + " se ha realizado con Ã©xito", AlertType.INFORMATION);
		} catch (DatosInvalidosException e) {
	...
	/**
	 * Datos de la ocupaciÃ³n de sillas del usuario
	...
	private boolean verificarDatos(String identificacionOPasaporte, String nombre, String apellido, String direccion, String correoElectronico, LocalDate fechaNacimiento, String direccionResidencia,
		...
		if(identificacionOPasaporte == null || identificacionOPasaporte.equals("")) notificacion += "Ingrese la identificaciÃ³n o pasaporte\n";
		...
		if(direccion == null || direccion.equals("")) notificacion += "Ingrese la direcciÃ³n\n";
		
		if(correoElectronico == null || correoElectronico.equals("")) notificacion += "Seleccione el correo electrÃ³nico\n";
		
		if(fechaNacimiento == null) notificacion += "Seleccione la fecha de nacimiento\n";
		
		if(direccionResidencia == null || direccionResidencia.equals("")) notificacion += "Ingrese la direcciÃ³n de residencia\n";
		
		if(tarjetaDebitoCredito == null || tarjetaDebitoCredito.equals("")) notificacion += "Ingrese el nÃºmero de la tarjeta dÃ©bito o crÃ©dito\n";
	...
	private void llenarRequerimientosPesoEquipaje() {
		...
		if(tiqueteSeleccion.getCiudadDestino().equalsIgnoreCase("Monterrey") || tiqueteSeleccion.getCiudadDestino().equalsIgnoreCase("CancÃºn")) {
			if(tiqueteSeleccion.getCiudadOrigen().equalsIgnoreCase("Economica")) {
				lblRequerimientoEquipajeClase.setText("1 Pieza, peso mÃ¡ximo 24kg");
				
				//  Quitar requerimientos de la clase econÃ³mica 
				cambiarEstado(false);
			} 
				
			if(tiqueteSeleccion.getCiudadOrigen().equalsIgnoreCase("Ejecutiva")) {
				lblRequerimientoEquipajeClase.setText("2 piezas con un peso mÃ¡ximo de 34 kilogramos cada una");
				cambiarEstado(true);
			}
		}
		if(tiqueteSeleccion.getCiudadDestino().equalsIgnoreCase("Buenos Aires") || tiqueteSeleccion.getCiudadDestino().equalsIgnoreCase("Los Ã�ngeles") ||
		   tiqueteSeleccion.getCiudadDestino().equalsIgnoreCase("BogotÃ¡") || tiqueteSeleccion.getCiudadDestino().equalsIgnoreCase("PanamÃ¡")) {
			if(tiqueteSeleccion.getCiudadOrigen().equalsIgnoreCase("Economica")) {
				lblRequerimientoEquipajeClase.setText("2 piezas con un peso mÃ¡ximo de 24 kilogramos cada una");
				cambiarEstado(true);
			} 
    ...
    /**
	 * validar que el usuario ingrese valores numÃ©ricos
	...
	private boolean validarNumero(String alto, String largo, String ancho) throws DatosInvalidosException {	
		...
		if(!(alto.matches("[0-9.]*"))) {
			notificacionNumero += "El alto debe ser un valor numÃ©rico\n";
		}
		if(!(largo.matches("[0-9.]*"))) {
			notificacionNumero += "El largo debe ser un valor numÃ©rico\n";
		}
		if(!(ancho.matches("[0-9.]*"))) {
			notificacionNumero += "El ancho debe ser un valor numÃ©rico\n";
		}
    ...
    void agregarEquipaje(ActionEvent event) {  
		...
		if(tiqueteSeleccion == null) aplicacionAerolinea.mostrarMensaje("Registro de Equipaje", "Registro de Equipaje", "Seleccione uno de los registros de tiquete(s) del cliente", AlertType.WARNING);
			...
			try {
				...
				aplicacionAerolinea.mostrarMensaje("Registro de Equipaje", "Registro de Equipaje", "Se ha aÃ±adido su equipaje con Ã©xito", AlertType.INFORMATION);				
	...
	/**
	 * Verificar la informaciÃ³n ingresada por el usuario
    ...
    private double calcularPesoTotal(String pesoEquipaje1, String totalDimensionEquipaje1, String pesoEquipaje2, String totalDimensionEquipaje2, String totalDimensionEquipajeMano,
		...
		if(!(totalDimensionEquipajeMano.equals(""))) {
			...
			if(dimensionEquipajeMano > 110) aplicacionAerolinea.mostrarMensaje("Registro de Equipaje", "Registro de Equipaje", "La suma de las dimensiones de su equipaje no puede ser mayor a 110 centÃ­metros", AlertType.WARNING);
		}
	...
	/**
	 * Validar peso y dimensiÃ³n del equipaje
	 * @param equipaje1, dimensionEquipaje, tamaÃ±o 
	 * @return
	 * @throws EquipajeException 
	 */
    private boolean validarEquipaje(double equipaje1, double dimensionEquipaje, int tamaÃ±o) throws EquipajeException {
    	String notificacionNumero = "";
    	
    	if(equipaje1 > tamaÃ±o) 
    		notificacionNumero += "El peso de su equipaje debe ser de mÃ¡ximo " + tamaÃ±o + " kilogramos\n";
		
    	if(dimensionEquipaje > 170) 
			notificacionNumero += "La suma de las dimensiones de su equipaje no puede ser mayor a 170 centÃ­metros \n";
	...
	private boolean validarNumero(String peso) throws DatosInvalidosException {
		...
		if(!(peso.matches("[0-9.]*"))) {
			notificacionNumero += "Debe ingresar un valor numÃ©rico\n";
		}
		if(notificacionNumero.equals("")) {
			return true;
		}
    ...
    void actualizarEquipaje(ActionEvent event) {
    	...
    	if(equipajeSeleccion != null) {
    		...
    		aplicacionAerolinea.mostrarMensaje("ActualizaciÃ³n Equipaje", "ActualizaciÃ³n Equipaje", "No se ha seleccionado ningÃºn equipaje", AlertType.INFORMATION);				
    ...
    private void actualizarEquipaje(String idEquipaje, String pesoEquipaje1, String dimensionEquipaje1, String pesoEquipaje2, String totalDimensionEquipaje2,
    	...
    	try {
			...
			aplicacionAerolinea.mostrarMensaje("ActualizaciÃ³n Equipaje", "ActualizaciÃ³n Equipaje", "Se ha actualizado su equipaje con Ã©xito", AlertType.INFORMATION);				
    ...
    void eliminarEquipaje(ActionEvent event) {
		...
		if(equipajeSeleccion != null) {
			boolean confirmacion = aplicacionAerolinea.mostrarMensaje("Registro de Equipaje", "Registro de Equipaje", "Â¿Desea eliminar el equipaje?");	
			
			
	    	if(confirmacion == true) {
				modelFactoryController.eliminarEquipaje(equipajeSeleccion.getIdEquipaje());
				aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n eliminaciÃ³n Equipaje", "NotificaciÃ³n eliminaciÃ³n Equipaje", "El equipaje ha sido eliminado", AlertType.INFORMATION);	
				
				listadoEquipajes.remove(equipajeSeleccion);
				tableViewEquipajes.refresh();
			} else {
				aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n eliminaciÃ³n Equipaje", "NotificaciÃ³n eliminaciÃ³n Equipaje", "No se ha eliminado el equipaje", AlertType.INFORMATION);		
			}
		} else {
			aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n eliminaciÃ³n Equipaje", "NotificaciÃ³n eliminaciÃ³n Equipaje", "No se ha seleccionado ningÃºn equipaje", AlertType.WARNING);		
		}
    }
  ...
  //------------- Datos Embarque -------------------------->>
    ...
    void llegadaCarroEmbarque(ActionEvent event) {
    	...
    	if(bicolaCarros.getTamaÃ±o() >= 10) {
    		aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", "No puede aÃ±adir mÃ¡s carros, la fila se encuentra llena", AlertType.WARNING);		
    ...
    void retirarVehiculo(ActionEvent event) {
    	...
    	//---------------------------------------------------------- Cambiar el color del botÃ³n para retirar el carro --------------------------------------------------------->>    	
		if (((Button)event.getTarget()).getStyle().equalsIgnoreCase("-fx-background-color: rgba(93, 109, 126,.3); -fx-border-color: #283747; -fx-border-width: 0px 0px 3px 0px;")) {
			if(posiciones+1 > 1) {
				aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", "No puede seleccionar mÃ¡s de un carro", AlertType.WARNING);		
			} else {
    ...
    /**
     * Volver a cambiar el color del botÃ³n cuando el carro ya haya sido retirado
     */
    ...
    void salidaCarroEmbarque(ActionEvent event) {
    	...
    	if(bicolaCarros.getTamaÃ±o() <= 0) {
    		aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", "No hay ningÃºn carro para realizar una salida", AlertType.WARNING);		
    	} else {    		
			try {
				double pesoTotal;
				
				if(lblPesoTotalCarroEmbarque == null || lblPesoTotalCarroEmbarque.getText().equals("")) {
					aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", "Seleccione equipajes para el carro embarque", AlertType.WARNING);		
					...
					aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", "Ha salido el carro embarque " + carroSalida.getNumIdentificacion() + " hacia el vuelo " + carroSalida.getNumAvion(), AlertType.INFORMATION);		
				}
	
			} catch (EquipajeException e1) {
				aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", e1.getMessage(), AlertType.WARNING);		
			}
    ...
    /**
     * AnimaciÃ³n de la salida de un carro embarque 
     */
    ...
    private double validarPeso(Label lblPesoTotalCarroEmbarque2) throws EquipajeException {
    	...
    	if(pesoTotal <= 0) {
    		...
    		notificacion = "El peso de los equipajes excede el peso mÃ¡ximo para el carro embarque";
    ...
    void retirarCarroEmbarque(ActionEvent event) {
		...
		if(posicionVehiculoRetirada == 0) {
			aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", "No ha seleccionado ningÃºn carro para retirar", AlertType.WARNING);				   
		} else if(bicolaCarros.getPrimero() == null) {
			aplicacionAerolinea.mostrarMensaje("NotificaciÃ³n Embarque Equipaje", "NotificaciÃ³n Embarque Equipaje", "No hay ningÃºn carro para retirar en esa posiciÃ³n", AlertType.WARNING);		
			...
			animacionRetirarCarroEmbarque(carroEncontrado, tamaÃ±oPila);												
		}
	}
	
	private void animacionRetirarCarroEmbarque(CarroEmbarque carroEncontrado, int tamaÃ±oPila) {
